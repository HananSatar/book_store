  ...
  handleSubmit(){
    ...
    (findDOMNode(this.refs.description).value==""))
    {
      ...
      const books=[{
        ...
        image_url: findDOMNode(this.refs.image_url).value,
        author: findDOMNode(this.refs.author).value,
        create_date: findDOMNode(this.refs.create_date).value
      }]
          ...
          <Well style={{'margin':'30px'}}>
            <Panel header=' Post a Book  (* required)'>
              ...
              <FormGroup controlId="publisher">
                ...
                <FormControl type="text" placeholder="Enter publisher" ref="publisher"/>
              </FormGroup>
              <FormGroup controlId="create_date">
                <ControlLabel>create_date</ControlLabel>
                <FormControl type="text" placeholder="Enter create_date" ref="create_date"/>
              </FormGroup>
              <FormGroup controlId="Image_URL">
                <ControlLabel>Image (.png, .jpg, .svg)*</ControlLabel>
                <FormControl type="text" placeholder="Enter URL" ref="Image_URL" onChange={this.imageLink.bind(this)} />
              </FormGroup>
